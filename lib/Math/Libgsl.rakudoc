...
unit package Math::Libgsl:ver<0.0.1>:auth<cpan:FRITH>;
...
=begin table
C function group       | Interface subs provided | Raku subs or methods
=======================================================================
Mathematical functions |         23              |         20
Polynomials            |         15              |         10
Special functions      |        519              |        515
Permutations           |         58              |         23
=end table
...
=head2 Math::Libgsl::Permutation

=head3 new(:$elems!)

The constructor accepts one parameter: the number of elements in the permutation.
